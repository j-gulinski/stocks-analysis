...
| S4 | Portfolio precision + auto-coverage | Current execution order 3 | in progress · `portfolio-performance-v1` independently computes live TWR/XIRR with visible method/window/gaps and verifier recomputation; mapping/auto-coverage/current-valuation aggregation remain |
