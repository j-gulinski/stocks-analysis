...
| S2 | Phase-aware Research list, single detail renderer | collecting/researched/valued rows render phase substance incl. valuation strip; legacy dossier paths deleted; stored-state agenda on top; S4 owns the portfolio phase and uncovered-holding reason | complete · 2026-07-14 |
