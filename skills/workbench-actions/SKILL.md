...
3. The company page renders `research-snapshot-v1` as the canonical six-section
   workspace when one exists. The prior dossier remains a labelled secondary
   audit view and cannot override snapshot status.
4. The financial-health sieve is a preliminary filter. Do not describe Altman
