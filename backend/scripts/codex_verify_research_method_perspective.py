"""Record verifier_strict output for one exact Research method perspective draft."""
...
from app.api.schemas import ResearchMethodPerspectiveVerificationIn
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Persist an independent verdict for an exact method perspective draft."
    )
    ...
    try:
        payload = ResearchMethodPerspectiveVerificationIn.model_validate(read_payload(args.input))
